...
func spawn_enemies(count: int):
	...
	for i in range(count):
		...
		# This connection logs a "hit" and base damage.
		...
		if not enemy_instance.is_connected("bonus_damage_dealt", Callable(slot_manager, "record_bonus_damage")):
			enemy_instance.connect("bonus_damage_dealt", Callable(slot_manager, "record_bonus_damage"))
		
		# --- ADD THIS CONNECTION ---
		if not enemy_instance.is_connected("procedural_damage_dealt", Callable(slot_manager, "record_procedural_damage")):
			enemy_instance.connect("procedural_damage_dealt", Callable(slot_manager, "record_procedural_damage"))
		# --- END ADD ---
